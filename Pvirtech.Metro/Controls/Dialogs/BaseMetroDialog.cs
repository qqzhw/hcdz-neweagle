...
namespace Pvirtech.Metro.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new Pvirtech.Metro.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private void Initialize([CanBeNull] MetroWindow owningWindow, [CanBeNull] MetroDialogSettings settings)
        {
            ...
            {
                this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Pvirtech.Metro;component/Styles/Controls.xaml") });
            }

            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Pvirtech.Metro;component/Styles/Fonts.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Pvirtech.Metro;component/Styles/Colors.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Pvirtech.Metro;component/Themes/Dialogs/BaseMetroDialog.xaml") });
