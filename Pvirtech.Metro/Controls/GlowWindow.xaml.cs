...
using Pvirtech.Metro.Models.Win32;
using Pvirtech.Metro.Native;
using NativeMethods = Pvirtech.Metro.Models.Win32.NativeMethods;
using RECT = Pvirtech.Metro.Native.RECT;
using SWP = Pvirtech.Metro.Models.Win32.SWP;
