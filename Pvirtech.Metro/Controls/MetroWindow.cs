...
using Pvirtech.Metro.Controls.Dialogs;
...
namespace Pvirtech.Metro.Controls
{
    ...
    public class MetroWindow : Window
    {
        ...
        /// <summary>
        /// Initializes a new instance of the Pvirtech.Metro.Controls.MetroWindow class.
        /// </summary>
        public MetroWindow()
        {
        ...
        {
            // PvirtechApps add these controls to the window with AddLogicalChild method.
