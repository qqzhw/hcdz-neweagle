...
namespace Pvirtech.Metro.Controls
{
    public static class WinApiHelper
    {
        ...
        internal static Standard.POINT GetPhysicalCursorPos()
        {
            ...
            {
                throw new PvirtechAppsException("Uups, this should not happen! Sorry for this exception! Is this maybe happend on a virtual machine or via remote desktop? Please let us know, thx.", exception);
            }
        }
    }
}