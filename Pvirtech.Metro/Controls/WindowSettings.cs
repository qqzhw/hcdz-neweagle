...
namespace Pvirtech.Metro.Controls
{
        ...
        public bool UpgradeSettings
        {
            get
            {
                ...
                catch (ConfigurationErrorsException ex)
                {
                    ...
                    throw new PvirtechAppsException(string.Format("The settings file '{0}' seems to be corrupted", filename ?? "<unknown>"), ex);
                }
                return true;
            }
    ...
    public class WindowSettings
    {
        ...
        protected virtual void LoadWindowState()
        {
            ...
            {
                throw new PvirtechAppsException("Failed to set the window state from the settings file", ex);
            }
        }
